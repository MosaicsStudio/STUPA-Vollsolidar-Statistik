...
The aim is to conduct a cross-sectional study to authentically capture the opinions of students regarding the \acrshort{dt} in the full solidarity model (instead of Naldo in the partial solidarity model). Our goal is to gain a comprehensive overview of approval, rejection, skepticism, or enthusiasm. This study will help us make an informed decision on whether and how the Deutschlandticket should influence our daily lives. By directly capturing the current mood of the student body, we aim to create a solid foundation for an informed decision.
...
\begin{figure}[H]
        \vspace{0.3\textwidth}
        \includegraphics[width=0.8\textwidth]{content/images/tt_02.png}
        \caption{\gls{tt} 2}
        \label{fig:table-tent}
    \end{figure}
\columnbreak
\begin{figure}[H]
        \vspace{0.3\textwidth}
        \includegraphics[width=0.8\textwidth]{content/images/tt_03.png}
        \caption{\gls{tt} 3}
        \label{fig:table-tent}
    \end{figure}
\end{multicols}
...
\begin{multicols}{2}
    {
        \begin{figure}[H] %lieber als Pie Chart
            \centering
            \includesvg[width=.95\textwidth]{content/auswertungen_svgs/role_counts.svg}
            \caption{Role distribution}
            \label{fig:countsPerRole}
        \end{figure}
    } \columnbreak {
        \begin{figure}[H]
            \centering
            \includesvg[width=.765\textwidth]{content/auswertungen_svgs/faculty_pie_chart.svg}
            \caption{Distribution of Faculties at Reutlingen University}
            \label{fig:facultiesDistribution}
        \end{figure}
    }
\end{multicols}
\end{comment}
...
\begin{multicols}{2}
    {
        \begin{figure}[H]
            \centering
            \includesvg[width=.95\textwidth]{content/auswertungen_svgs/faculty_counts.svg}
            \caption{Faculty distribution}
            \label{fig:countsPerFaculty}
        \end{figure}
    } \columnbreak {
        \begin{figure}[H]
            \centering
            \includesvg[width=.95\textwidth]{content/auswertungen_svgs/faculty_distribution_normalized.svg}
            \caption{Faculty distribution adjusted for overall faculty size}
            \label{fig:countsPerFacultyNormalized}
        \end{figure}
    }
\end{multicols}
\end{comment}
...
The current (7/4/2024) confidence level of 85\% demonstrate that our current sample size of 322 is close to being representative, but slightly below the desired threshold of a 95\% for which a sample size of 357 would be needed.  
...
\begin{center}
    \englishQuote{What is the level of acceptance among the students of Reutlingen University for a \acrshort{dt} in the full solidarity model?}
\end{center}
...
This indicates that while there is strong overall support for the concept of the \acrshort{dt}, the current pricing structure may be a significant barrier to broader acceptance.
\begin{comment}
\begin{multicols}{2}
    {
        \begin{figure}[H]
            \centering
            \includesvg[width=1\textwidth]{content/auswertungen_svgs/support_pie_chart.svg}
            \caption{\texttt{G03Q01} Support of the \textit{\acrshort{dt}} in the \acrshort{fsm} in general}
            \label{fig:meinungDTInVollsolidarGenerell}
        \end{figure}
    } \columnbreak {
        \begin{figure}[H]
            \centering
            \includesvg[width=1\textwidth]{content/auswertungen_svgs/support_conditions_pie_chart.svg}
            \caption{\texttt{G06Q01}: Position on the proposed conditions (\ref{InfoText})}
            \label{fig:positionOnTheProposedConditions}
        \end{figure}
    }
\end{multicols}
\end{comment}
...
\begin{figure}[H]
    \centering
    \includesvg[width=0.6\textwidth]{content/auswertungen_svgs/reasonable_amounts_histogram.svg}
    \caption{\texttt{G03Q01} Appropriate amounts according to students}
    \label{fig:betragVollsolidarAngemessenNum}
\end{figure}
\end{comment}
...
\begin{figure}[H]
    \centering
    \includesvg[width=0.7\textwidth]{content/auswertungen_svgs/fairness_pie_chart.svg}
    \caption{\texttt{G03Q01} Opinion on the fairness of the model}
    \label{fig:fairnessPerception}
\end{figure}
\end{comment}
\pagebreak
...
\begin{enumerate}
    ...
    \item \englishQuote{Control question to check if the participant understood the info-text}
