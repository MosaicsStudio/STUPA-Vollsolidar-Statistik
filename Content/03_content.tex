...
\begin{multicols}{2}
    ...
    \columnbreak
    The pie chart in \ref{fig:ModesOfTransport} shows the distribution of the primary modes of transportation used by participants to reach the university.
...
\begin{multicols}{2}
    ...
    \columnbreak
    The age distribution of the participants is shown in \ref{fig:AgeDistribution}. The majority of participants are under 26 years old, which is consistent with the typical student age range. This distribution is important for analyzing the data, as it allows us to identify potential differences in opinions and behaviors between younger and older students.
\end{multicols}
